      ...
      <div className="container-custom">
        <div className="flex flex-col items-center">
          <motion.div
            ...
            className="mb-6"
          >
            <span className="text-2xl font-bold gradient-text">Oladimeji Oladiti</span>
          </motion.div>
          ...
          >
            <span className="flex items-center justify-center gap-1">
              Made with <Heart className="h-4 w-4 text-red-500 fill-red-500" /> by Oladimeji Oladiti
            </span>
